...
//		}
//
//		System.out.println("모든 과목에서 받은 점수의 합은 " + sum + "입니다.");	// 'sum'에 저장된 값, 즉 모든 점수의 합이 출력
//
//		System.out.println("이 학생의 평균은 " + (sum / grade.length) + "입니다.");	//'sum'을 'grade'배열의 길이로 나눈 값, 즉 평균이 출력
